...
@client.onMessage(command=('ping', 'www'),
                  outgoing=True,
                  regex='ping$',
                  builtin=True)
...
@client.onMessage(command=('shutdown', 'misc'),
                  outgoing=True,
                  regex='shutdown$',
                  builtin=True)
...
@client.onMessage(command=('restart', 'misc'),
                  outgoing=True,
                  regex='restart$',
                  builtin=True)
...
@client.onMessage(command=('loglevel', 'logging'),
                  outgoing=True,
                  regex=r'loglevel(?: |$)(\w*)',
                  builtin=True)
...
@client.onMessage(command=('logs', 'logging'),
                  outgoing=True,
                  regex=r'logs(?: |$)(\d+|\w+)?',
                  builtin=True)
